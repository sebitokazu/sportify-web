...
class RoutinesApi{
    ...
    static async retrieveRoutines(difficulty, page, size, orderBy, direction, controller){
        return await Api.get(`${RoutinesApi.url}/?difficulty=${difficulty}&page=${page}&size=${size}&orderBy=${orderBy}&direction=${direction}`, true, controller);
    }
    ...
    static async modifyRoutine(routineId, routine, controller) {
        return await Api.put(`${RoutinesApi.url}/${routineId}`, true, routine, controller);
    }
    ...
    static async getRoutine(routineId, controller) {
        return await Api.get(`${RoutinesApi.url}/${routineId}`,true,  controller);
    }

    static async getRoutineRatings(routineId, controller){
        return await Api.get(`${RoutinesApi.url}/${routineId}/ratings`,true,  controller);
    }

    static async addRoutineRating(routineId, rating, controller){
        return await Api.post(`${RoutinesApi.url}/${routineId}/ratings`,true, rating, controller);
    }

    static async getCycles(routineId, controller){
        return await Api.get(`${RoutinesApi.url}/${routineId}/cycles`, true, controller);
    }

    static async addCycle(routineId, cycle, controller){
        return await Api.post(`${RoutinesApi.url}/${routineId}/cycles`,true, cycle, controller);
    }
    ...
    static async getExercise(routineId, cycleId, exerciseId, controller){
        return await Api.get(`${RoutinesApi.url}/${routineId}/cycles/${cycleId}/${exerciseId}`, true, controller);
    }

    static async updateExercise(routineId, cycleId, exerciseId, exercise, controller){
    ...
    static async getImages(routineId, cycleId, exerciseId, controller){
        return await Api.get(`${RoutinesApi.url}/${routineId}/cycles/${cycleId}/${exerciseId}/images`, true, controller);
    }
    ...
    static async getImageById(routineId, cycleId, exerciseId, imageId, controller){
        return await Api.get(`${RoutinesApi.url}/${routineId}/cycles/${cycleId}/exercises/${exerciseId}/images/${imageId}`,true, controller);
    }

    static async updateImage(routineId, cycleId, exerciseId, imageId, image, controller){
        return await Api.put(`${RoutinesApi.url}/${routineId}/cycles/${cycleId}/exercises/${exerciseId}/images/${imageId}`,true, image, controller);
    }

    static async deleteImage(routineId, cycleId, exerciseId, imageId, controller){
        return await Api.delete(`${RoutinesApi.url}/${routineId}/cycles/${cycleId}/exercises/${exerciseId}/images/${imageId}`,true, controller);
    }

    static async getVideos(routineId, cycleId, exerciseId, controller){
        return await Api.get(`${RoutinesApi.url}/${routineId}/cycles/${cycleId}/${exerciseId}/videos`, true, controller);
    }

    static async addVideo(routineId, cycleId, exerciseId, video, controller){
        return await Api.post(`${RoutinesApi.url}/${routineId}/cycles/${cycleId}/exercises/${exerciseId}/videos`,true, video, controller);
    }

    static async getVideoById(routineId, cycleId, exerciseId, videoId, controller){
        return await Api.get(`${RoutinesApi.url}/${routineId}/cycles/${cycleId}/exercises/${exerciseId}/videos/${videoId}`,true, controller);
    }

    static async updateVideo(routineId, cycleId, exerciseId, videoId, video, controller){
        return await Api.put(`${RoutinesApi.url}/${routineId}/cycles/${cycleId}/exercises/${exerciseId}/videos/${videoId}`,true, video, controller);
    }

    static async deleteVideo(routineId, cycleId, exerciseId, videoId, controller){
        return await Api.delete(`${RoutinesApi.url}/${routineId}/cycles/${cycleId}/exercises/${exerciseId}/videos/${videoId}`,true, controller);
    }
