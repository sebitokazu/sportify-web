...
class RoutinesApi{
    ...
    static async getExercises(routineId, cycleId, controller){
        return await Api.get(`${RoutinesApi.url}/${routineId}/cycles/${cycleId}/exercises`, true, controller);
    }
    ...
    static async getVideos(routineId, cycleId, exerciseId, controller){
        return await Api.get(`${RoutinesApi.url}/${routineId}/cycles/${cycleId}/exercises/${exerciseId}/videos`, true, controller);
    }
