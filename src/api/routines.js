...
class RoutinesApi {
    ...
    static async getExercise(routineId, cycleId, exerciseId, controller) {
        return await Api.get(
            `${RoutinesApi.url}/${routineId}/cycles/${cycleId}/${exerciseId}`,
            true,
            controller
        );
    }
    ...
    static async getImages(routineId, cycleId, exerciseId, controller) {
        return await Api.get(
            `${RoutinesApi.url}/${routineId}/cycles/${cycleId}/${exerciseId}/images`,
            true,
            controller
        );
    }
    ...
    static async getVideos(routineId, cycleId, exerciseId, controller) {
        return await Api.get(
            `${RoutinesApi.url}/${routineId}/cycles/${cycleId}/${exerciseId}/videos`,
            true,
            controller
        );
    }
